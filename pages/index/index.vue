  ...
  <div class="pt-[60px] relative">
    ...
    >
      <div class="container flex flex-col tablet:flex-row items-center gap-10">
        ...
        >
          ...
          <h3
            class="text-black text-[28px] font-bold mt-[2px] text-center tablet:text-right"
          >
            مبتکر شتابدهی استعداد و آموزش زبان برنامه نویسی در ایران
          </h3>
          <h3
            class="text-black text-[18px] font-bold mt-[2px] text-center tablet:text-right"
          >
            فرزندانمان را برای زندگی در دنیای دیجیتال آماده کنیم
          </h3>
          <p
            class="paragraph mt-[50px] max-w-[80%] text-center tablet:text-right"
          >
        ...
        >
          ...
          />
          <span
            class="w-14 h-14 rounded-full bg-[#f7a739] absolute right-[-6px] top-[-6px] z-10"
          ></span>
          <span
            class="w-16 h-16 rounded-full bg-blue absolute right-[12px] bottom-[-4px] z-10"
          ></span>
          <span
            class="w-8 h-8 rounded-full bg-[#53b848] absolute left-[-6px] bottom-[-6px] z-10"
          ></span>
          <span
            class="w-24 h-24 rounded-full bg-red absolute left-[-18px] top-[10px]"
          ></span>
          <span
            class="w-64 text-center p-2 rounded-full bg-gradient-to-b from-[#f7a739]/5 to-[#f7a739]/10 absolute left-0 bottom-[20px] z-10 backdrop-blur-[8px] visible max-[960px]:invisible"
          >
    ...
    <section class="relative mt-[100px] pb-[150px]">
      ...
      <div class="flex mt-[120px] container items-center">
        <div class="flex flex-col max-w-[50%] pr-[100px]">
          ...
          >
            <swiper-slide
              class="rounded-default overflow-hidden z-10 h-full"
        ...
        >
          <span
            class="absolute top-0 bottom-[50%] right-0 left-0 bg-gradient-to-b from-[#fff] to-transparent"
          ></span>
          <span
            class="absolute top-[50%] bottom-0 right-0 left-0 bg-gradient-to-b to-[#fff] from-transparent"
          ></span>
        </div>
      </div>
    </section>
    ...
    >
      ...
      >
        ...
        />
        <div
          class="absolute right-0 left-0 top-[84.3px] bottom-0 flex items-center justify-center"
        >
      ...
      <div class="col-span-6">
        ...
        <div class="grid grid-cols-2 gap-[30px] mt-[50px]">
          ...
          <select-input
            ...
            valueInput="uid"
          />
          <text-input v-model:value="form.birthday" label="متولد" />
          <select-input
            ...
            valueInput="id"
          />
          <text-input v-model:value="form.phone" label="شماره تماس" />
          <select-input
